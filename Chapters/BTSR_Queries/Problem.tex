...
\begin{figure}[!tb]
 \centering
 \subfloat[$Q_{bb}(T_q, \theta_{sp}, \theta_{ts})$]{\includegraphics[width=0.45\textwidth]{figures/query_bb.png}\label{subfig:example_queries_bb}}
 \qquad
 \subfloat[$Q_{kb}(T_q, k, \theta_{ts})$]{\includegraphics[width=0.45\textwidth]{figures/query_kb.png}\label{subfig:example_queries_kb}}
