...
\begin{figure}[!tb]
 \centering
 \subfloat[Accuracy in spatial domain.]{\includegraphics[width=0.4\textwidth]{figures/BTSR_error_sp.pdf}\label{subfig:btsr_error_sp}}
 \subfloat[Accuracy in time domain.]{\includegraphics[width=0.4\textwidth]{figures/BTSR_error_ts.pdf}\label{subfig:btsr_error_ts}} \\
 \subfloat[Response time.]{\includegraphics[width=0.4\textwidth]{figures/BTSR_time.pdf}\label{subfig:btsr_time}}\
...
\begin{figure*}[!ht]
 \centering
 \fbox{\includegraphics[width=0.75\textwidth]{figures/timebox1.pdf}}
...
\begin{figure*}[!ht]
 \centering
 \fbox{\includegraphics[width=0.75\textwidth]{figures/timebox2.pdf}}
...
\begin{figure}[!tb]
 \centering
 \subfloat[Accuracy in spatial domain.]{\includegraphics[width=0.4\textwidth]{figures/geo_iSAX_error_sp.pdf}\label{subfig:geo_iSAX_error_sp}}
 \subfloat[Accuracy in time series domain.]{\includegraphics[width=0.4\textwidth]{figures/geo_iSAX_tilemapDiff.pdf}\label{subfig:geo_iSAX_tilemapDiff}} \\
 \subfloat[Response time.]{\includegraphics[width=0.45\textwidth]{figures/geo_iSAX_time.pdf}\label{subfig:geo_iSAX_time}}\
