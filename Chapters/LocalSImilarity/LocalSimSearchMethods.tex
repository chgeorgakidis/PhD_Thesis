...
\begin{figure}[!tb]
 \centering
 \subfloat[Example of a node's MBTS.]{\includegraphics[width=0.75\textwidth]{Figures/bundles_node.png}\label{subfig:bundles}} \\
 \subfloat[Segmenting can eliminate whitespace.]{\includegraphics[width=0.75\textwidth]{Figures/bundles_node_partition.png}\label{subfig:bundles_part}}
 \vspace{-10pt} 
