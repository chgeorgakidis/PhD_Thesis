...
\begin{figure}[!t]
 \centering
 \subfloat[Pair with a starting point before $t'$.]{\includegraphics[width=0.43\textwidth]{figures/proofLeft.png}\label{fig:proof1}}
 \subfloat[Pair with an ending point after $t'$.]{\includegraphics[width=0.43\textwidth]{figures/proofRight.png}\label{fig:proof2}}
